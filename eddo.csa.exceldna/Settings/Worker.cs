...
namespace eddo.csa.exceldna.Settings
{
    public class Worker
    {
        ...
        private readonly ServerOptions _optionsRegisteredManually;
        #endregion Fields


        #region Constructors & Destructors
        public Worker( IConfiguration configuration,
                        IOptions<ContainerOptions> optionsRegisteredByAddOptions,
                        IOptions<OrderOptions> optionsRegisteredByConfigure,
                        IOptions<ServerOptions> optionsRegisteredManually )
        {
            ...
            this._optionsRegisteredManually = optionsRegisteredManually.Value;
        }
        ...
        public void DoWork()
        {
            ...
            // TODO: Implement Secrets on startup
